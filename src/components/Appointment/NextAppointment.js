...
const NextAppointment = ({ date, time }) => {
  return (
    <div className="">
      ...
      <div className="px-[16px] mt-[8px] typographyTextSmMedium h-[96px] shadow-[0px_1px_3px_rgba(16,24,40,0.1)] bg-base-white border-[1px] border-solid border-gray-200 rounded-[8px]">
